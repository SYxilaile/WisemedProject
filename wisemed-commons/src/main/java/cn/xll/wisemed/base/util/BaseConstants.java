...
import cn.xll.wisemed.base.pojo.enums.BaseEnumConstants;
...
public class BaseConstants {
	...
	static{
		try {
			props.load(BaseEnumConstants.class.getClassLoader().getResourceAsStream("props/base/base.properties"));
		}catch (Exception e){
			e.printStackTrace();
		}
	}
